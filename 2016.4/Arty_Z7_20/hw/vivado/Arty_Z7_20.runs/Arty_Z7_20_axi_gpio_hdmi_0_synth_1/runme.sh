...
HD_PWD='C:/sam_work/git/digilent/Arty-Z7-20-base/proj/Arty_Z7_20.runs/Arty_Z7_20_axi_gpio_hdmi_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty_Z7_20_axi_gpio_hdmi_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Arty_Z7_20_axi_gpio_hdmi_0.tcl
